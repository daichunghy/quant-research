...
- npm package: `@agentbiz/quant-research@0.1.0-alpha.3`, only if the `@agentbiz` namespace is writable and npm OTP verification is completed by the authenticated account;
